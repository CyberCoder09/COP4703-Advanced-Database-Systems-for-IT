...
from scripts.database import (
    get_db,
)  # Importing the get_db function from the database module, which is used to create a new database session for each request
from sqlalchemy.orm import (
    Session,
)  # Importing the Session class from SQLAlchemy, which is used to manage database transactions
from sqlalchemy import (
    func,
)  # Importing the func function from SQLAlchemy, which is used to perform aggregate functions
from fastapi import (
    Depends,
    FastAPI,
    HTTPException,
